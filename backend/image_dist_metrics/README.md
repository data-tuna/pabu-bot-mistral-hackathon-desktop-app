...
From this folder (`image-compare-main`):

```powershell
cargo run --example demo_compare -- ../scripts/image_3.png ../scripts/image_4.png 0.985 diff.png
```

What this does:

- Compares two images using hybrid RGB similarity.
- Prints scores to the terminal.
- Saves a visual diff image to `diff.png`.

### 3) Understand the score quickly

- `1.0` means images are effectively identical.
- Lower score means more change.
- A practical starting threshold is `0.985` for screenshot deltas.
